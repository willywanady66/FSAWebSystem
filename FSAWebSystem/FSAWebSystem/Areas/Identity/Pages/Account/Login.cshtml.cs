...
namespace FSAWebSystem.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<FSAWebSystemUser> signInManager, ILogger<LoginModel> logger, IUserService userService)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(userUnilever != null)
                {
                    if(userUnilever.IsActive)
                    {
                        ...
                        {
                            ModelState.AddModelError(string.Empty, "Wrong Email/Password.");
                            return Page();
                        }
                    }
                }
