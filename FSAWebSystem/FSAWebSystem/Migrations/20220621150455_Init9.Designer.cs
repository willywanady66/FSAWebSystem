...
namespace FSAWebSystem.Migrations
{
    ...
    [Migration("20220621150455_Init9")]
    partial class Init9
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BannerUserUnilever", b =>
                {
                    ...
                    b.HasKey("BannerId", "UserUnileversId");
            ...
            modelBuilder.Entity("FSAWebSystem.Models.RoleUnilver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c90cac7-05e0-4ad3-b117-bf2107c9ffdf"),
                            RoleName = "Administrator"
                        },
                        new
                        {
                            Id = new Guid("c270be53-53e3-4330-8b7d-4a72a1277fec"),
                            RoleName = "Approver"
                        },
                        new
                        {
                            Id = new Guid("7d16658d-47ea-40a8-8e3d-900e1f263304"),
                            RoleName = "Requestor"
                        },
                        new
                        {
                            Id = new Guid("d0f9d21f-4418-4187-8cee-6d854da377c0"),
                            RoleName = "Support"
                        });
                });
            ...
            modelBuilder.Entity("FSAWebSystem.Models.RoleAccess", b =>
                {
                    b.HasOne("FSAWebSystem.Models.RoleUnilver", "Role")
                        .WithMany()
