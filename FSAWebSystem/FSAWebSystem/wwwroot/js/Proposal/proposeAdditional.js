$(document).ready(function () {
    ...
    var tableProposals = $("#dataTableProposalProposeAdditional").DataTable({
        "processing": true,
        "serverSide": true,
        autoWidth: false,
        "ajax": {
            ...
            type: "POST",
            data: function (d) {
                return $.extend(d, { "proposalInputs": getUserInput(proposalInputs), "month": month, "year": year, "type" : 1    });
            }
        },
        "columns": [
            { "data": "bannerName" }, //0
            ...
            },
            {
                ...
                "render": function (data, type, full, meta) {
                    ...
                    remarks.forEach(function (item) {
                        var remark = item;
                        if (remark == full.remark && full.type == 1) {
    ...
    var tableHistory = $("#dataTableProposalHistory").DataTable({
        ...
        "ajax": {
            ...
            type: "POST",
            data: function (d) {
                return $.extend(d, { "month": month, "year": year, type: 1 });
            }
        },
        columns: [
            { "data": "submittedAt" }, //0
            ...
            { "data": "approvedProposeAdditional" },   //7
            { "data": "remark" },   //8
            { "data": "status" },   //9
            { "data": "approvedBy" },   //10
